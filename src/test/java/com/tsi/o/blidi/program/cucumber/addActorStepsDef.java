...
public class addActorStepsDef {
    ...
    public void i_have_actors_first_name() {
        // Write code here that turns the phrase above into concrete actions


        throw new io.cucumber.java.PendingException();
    }
    @Given("I dont have their last name")
    public void i_dont_have_their_last_name() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    @When("I try to add them into database")
    public void i_try_to_add_them_into_database() {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
